...
HD_PWD='D:/Xilinx/hw/lab3/fifoqueue/fifoqueue.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log queue.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source queue.tcl -notrace
