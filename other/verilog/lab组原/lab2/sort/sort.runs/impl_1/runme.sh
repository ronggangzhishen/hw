...
HD_PWD='D:/Xilinx/hw/lab2/sort/sort.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sort.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sort.tcl -notrace
