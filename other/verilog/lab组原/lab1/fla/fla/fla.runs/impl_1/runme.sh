...
HD_PWD='D:/Xilinx/hw/lab1/fla/fla/fla.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fla.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fla.tcl -notrace
